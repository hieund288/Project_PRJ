                ...
                <div class="col-md-12">
                    <form name="aspnetForm" method="post" action="./Default.aspx" id="aspnetForm">
                        <div>
                            ...
                            <input type="hidden" name="__VIEWSTATE" id="__VIEWSTATE" value="/wEPDwUJNjc2MTUyNDc0D2QWAmYPZBYCAgMPZBYEAgEPFgIeB1Zpc2libGVoZAIFD2QWAgIBD2QWAgIBDxBkZBYBZmRkICmGFH+uwUl/btZw7W9+0i7UnVf3WvUttrw5Yp++aLM=" />
                        </div>
                        ...
                        <div>
                            ...
                            <input type="hidden" name="__EVENTVALIDATION" id="__EVENTVALIDATION" value="/wEdAAiI8yN8TXNo/iy/IkdmpFYO1ZWqR6ljRJGb9mEZktA3XKqU7CaSg+wPXz/3l6S9ZjiSD1GKPUsR9KXpKj3jOOWku49L3JqFCWR9GGhMPmiNS0ZIBGGuozU0xJ5NRQcV2LFvqmBvaEIHX/Biv0pDwM/1BT+GWrfmMj8WjvmevktzuKIkbNkwFgOFeyuSNTPMOVizKW5s1UlieaYStIbyGmrJ" />
                        </div>
                                            ...
                                            <div class="row">
                                                <div class="col-md-6">
                                                    <div style="border: solid 1px #ccc; height: 150px;">
                                                        <fieldset>
                                                            <legend><span class="label label-default  btn-warning"><b>Ph? huynh</b></span></legend>
                                                            <div style="margin-top: -15px">
                                                                <a href="Phuhuynh/Login.aspx">
                                                                    <h3>
                                                                        <span class="btn btn-primary"><b>??ng nh?p</b></span></h3>
                                                                </a>
                                                            </div>
                                                        </fieldset>
                                                    </div>
                                                ...
                                                <div class="col-md-6">
                                                    <div style="border: solid 1px #ccc; height: 150px;">
                                                        <fieldset>
                                                            <legend><span class="label label-default  btn-warning"><b>Sinh viên, Gi?ng viên, Cán b? ?H-FPT</b></span></legend>
                                                            <br />
                                                            <div id="loginform" 
                                                                    ...
                                                                    <div class="row">
                                                                        <div class="col-sm-4">
                                                                            ...
                                                                            <select name="ctl00$mainContent$ddlCampus" onchange="javascript:setTimeout( & #39; __doPostBack(\ & #39; ctl00$mainContent$ddlCampus\ & #39; , \ & #39; \ & #39; ) & #39; , 0)" id="ctl00_mainContent_ddlCampus" class="btn btn-default">
                                                                                ...
                                                                                <option value="3">FU-H&#242;a L?c</option>
                                                                                <option value="4">FU-H? Ch&#237; Minh</option>
                                                                                <option value="5">FU-?&#224; N?ng</option>
                                                                                <option value="6">FU-C?n Th?</option>
                                                                                <option value="7">FU-Quy Nh?n</option>
